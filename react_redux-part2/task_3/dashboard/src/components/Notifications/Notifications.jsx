        ...
        {isLoading ? (
          ...
          <>
            ...
            <div style={{ marginBottom: '10px' }}>
              <p className={css(styles.p)}>Filter by:</p>
              <button onClick={handleSetFilterUrgent} aria-label="Urgent">‼️</button>
              <button onClick={handleSetFilterDefault} aria-label="Default">??</button>
            </div>

            {filteredNotifications.length > 0 ? (
              <>
                <p className={css(styles.p)}>
                  Here is the list of notifications ({currentFilter})
                </p>
